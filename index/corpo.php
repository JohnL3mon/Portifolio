...
function chamaCorpo() {
    if (document.getElementById('pag01').checked) {
        ...
        document.getElementById('corpo03').style.display = 'flex';
         document.getElementById('corpo02').style.display = 'none';
         document.getElementById('corpo01').style.display = 'none';
         document.getElementById('corpo04').style.display = 'none';
         document.getElementById('corpo05').style.display = 'none';
    ...
    <div class="corpo">
        ...
        <div class="corpo02" id="corpo02">
            ...
            <div class="corpo02A ordemCorpo2">
            ...
            <div class="corpo02B ordemCorpo2">
                    ...
                    <div class="conteudoCorpoB">
                        <p class="tituloPag tituloPag02" style="-webkit-text-stroke: #25281D 1px; padding-top: 6px;">&nbsp;&nbsp;Conhecimentos</p>
                            <ul class="topicoPag" style="width:450px !important;">
                                ...
                                <li class="topicoB">Domínio de montagem e soluções em hardware;</li>
            ...
            <div class="corpo03" id="corpo03">
                ...
                <div class="corpo03A ordemCorpo3">
                    ...
                    <div class="container">
                        <div class="conteudoCorpoB">
                            <p class="tituloPag tituloPag02" style="color: #866399 !important;">Minha Experiência</p>
                            <p class="nota" style="width:390px !important; font-size: 18px !important;">&nbsp;&nbsp;Passei pelos mais variados setores e cenários, iniciei a jornada como programador Web Jr, onde fiz trabalhos bem interessantes. Migrei para suporte devido a falta de dinheiro, adquiri muita paciência e resiliência indo para o setor de infra em seguida.<br>
                ...
                <div class="corpo03B ordemCorpo3">
                    ...
                    <div class="containerB" style="max-width:350px;">
                        ...
                        <div class="conteudoCorpoB">
                            ...
                            <ul class="topicoPag" style="width:450px !important;"> 
                                <li class="topico">Dynamotech - 2019/2020 - Programador Jr focado em Web, sendo Java Script CSS e HTML os principais trabalhos;</li>
                                <li class="topico">Mais Nove - 2020 - Suporte em Redes e TI, analista de projetos Jr;</li>
                                <li class="topico">Itevo - 2020/2023 - Suporte em redes e analista de projetos Jr;</li>
                                <li class="topico">Spero Fotos - 2020/2023 Editor de fotos em eventos e designer;</li>
                                <li class="topico">Dynamotech - 2023/Atualmente - Suporte em redes, designer e analista de projetos Jr.</li>
                            </ul>
                        </div>
                    </div>
